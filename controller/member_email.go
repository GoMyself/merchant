...
type EmailRecordController struct{}

// List 验证码列表
func (that *EmailRecordController) List(ctx *fasthttp.RequestCtx) {
	...
	data, err := model.EmailList(uint(page), uint(pageSize), startTime, endTime, username, mail, state, ty)
	if err != nil {
