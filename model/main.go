...
var (
	...
	dividendFields           = []string{"id", "prefix", "uid", "ty", "pid", "ptitle", "level", "username", "amount", "water_limit", "water_multiple", "water_flow", "remark", "review_remark", "state", "automatic", "apply_at", "apply_uid", "apply_name", "review_at", "review_uid", "review_name", "top_uid", "top_name", "parent_uid", "parent_name"}
